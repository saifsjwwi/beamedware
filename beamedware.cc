...
y.AddButton("SpiderMan", function()
...
y.AddButton("Skinny Af ", function()
...
y.AddButton("Open Admin Door [CS]", function()
...
y.AddButton("Close Admin Door [CS]", function()
	game:GetService('Workspace'):FindFirstChild('MAP'):FindFirstChild('EVIL_SPECIAL'):FindFirstChildWhichIsA('Sound').Playing = true;
	for i = 1, 26 do
		wait();
		workspace:FindFirstChild('MAP'):FindFirstChild('EVIL_SPECIAL').CFrame = workspace:FindFirstChild('MAP'):FindFirstChild('EVIL_SPECIAL').CFrame + Vector3.new(0, -1, 0);
...
y.AddButton("Taze Animation [H]", function()
local mouse = game.Players.LocalPlayer:GetMouse()
	mouse.KeyDown:connect(function(key)
		if key == "h" then
			local Swing = Instance.new('Animation');
...
y.AddButton("Destroy All Seats", function()
...
y.AddButton("Destroy Face [FE]", function()
	game.Players.LocalPlayer.Character.Head.face:Destroy()
end)
y.AddSlider("Money Change", {Min = 0, Max = 999999999, Def = 200000}, function(Value)
